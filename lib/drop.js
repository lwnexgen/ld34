ig.module(
	...
	EntityCoin = ig.Entity.extend({
		...
		this.addAnim( 'idle', 0.1, [0,0,0,0,1,1] );		
	...
	DropGame = ig.Game.extend({
		...
		this.backgroundMaps.push( new ig.BackgroundMap(16, this.map, 'media/stalk16.png' ) );
		...
		if( ig.input.pressed('bomb') ) {
		    this.spawnEntity( EntityCoin, this.player.pos.x, this.player.pos.y + 10 );
		}
